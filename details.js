window.onload = function() {
    ...
    if(aiButton) {
        aiButton.addEventListener('click', async () => {
            ...
            try {
                const response = await fetch(`https://my-ai-analyzer.onrender.com/get-pm-checklist?name=${encodeURIComponent(currentEquipment.name)}&model=${encodeURIComponent(currentEquipment.model)}`);
